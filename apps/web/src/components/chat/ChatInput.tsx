...
export function ChatInput({ onSend, disabled }: ChatInputProps) {
  ...
  return (
    <div className="relative">
      ...
      {/* Input Container */}
      <div className="relative flex items-end gap-2 bg-dark-surface rounded-ai-lg border border-dark-border p-2 focus-within:ring-2 focus-within:ring-brand-primary/50 focus-within:border-brand-primary transition-all">
        {/* Toolbar */}
      ...
      <div className="mt-2 px-2 flex items-center justify-between text-xs text-dark-text-tertiary">
        <span>
          Press <kbd className="px-1.5 py-0.5 bg-dark-hover rounded">@</kbd> to mention an agent
        </span>
        <span>
